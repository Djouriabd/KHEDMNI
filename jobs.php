    ...
    <header class="navbar">
        <nav>
            ...
            <ul class="blue">
                ...
                <li><a href="services.html">Find Jobs</a></li>
                <li><a href="contact.html">Employers</a></li>
                <!--<li><a href="contact.html">Admin</a></li>     for admin brk ykhrjlo--> 
                <li><a href="about.html">About Us</a></li>
            </ul>
            <ul class="auth-links">
                <li id="hna"><a href="log_in.html">Log in</a></li>
    ...
    <main class="job-page">
        ...
        <div class="job-card">
            <div class="job-header">
                ...
                <p>Salary: 20,000 INR - 25,000 INR</p>
                <p><strong>Google Inc.</strong> - New Delhi, India</p>
            </div>
        ...
        <div class="job-card">
            <div class="job-header">
                <h3>Senior UI/UX Designer <span class="full-time">Full Time</span></h3>
                <p>Salary: $30,000 - $55,000</p>
                <p><strong>Apple</strong> - Boston, USA</p>
            </div>
            <div class="job-footer">
